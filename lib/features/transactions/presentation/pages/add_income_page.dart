...
class _AddIncomePageState extends State<AddIncomePage> {
  ...
  Future<void> _loadCurrentBalance() async {
    try {
      ...
      final expenses = await _transactionRepository.getTotalExpenses();
      setState(() {
  ...
  Future<void> _saveIncome() async {
    ...
    try {
      ...
      final transaction = TransactionModel(
        ...
        metadata: {
          'depositMethod': _selectedDepositMethod.toString().split('.').last,
          'phoneNumber': _selectedDepositMethod == IncomeDepositMethod.mpesa ? _phoneNumberController.text : null,
          'bankName': _selectedDepositMethod == IncomeDepositMethod.bankTransfer ? _bankNameController.text : null,
          'accountNumber': _selectedDepositMethod == IncomeDepositMethod.bankTransfer ? _accountNumberController.text : null,
          'previousBalance': _currentBalance,
          'newBalance': _currentBalance + amount,
        },
      );
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'New balance: ${_currencyFormat.format(_currentBalance + amount)}',
  ...
  Widget _buildDepositMethodField() {
    return Column(
      ...
      children: [
        ...
        // Show relevant input fields based on selected method
        if (_selectedDepositMethod == IncomeDepositMethod.mpesa)
          TextFormField(
        ...
        if (_selectedDepositMethod == IncomeDepositMethod.bankTransfer) ...[
          TextFormField(
